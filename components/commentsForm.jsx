...
const commentsForm = ({slug}) => {
  ...
  return (
    <div className='bg-white shadow-lg rounded-lg p-8 pb-12 mb-8'>
      <h3 className='text-xl font-semibold mb-8 border-b pb-4'>Leave a Reply</h3>
      ...
      <div className='mt-8'>
        ...
        className='transition duration-500 ease hover:bg-indigo-900 inline-block bg-black text-lg text-white px-8 py-3 cursor-pointer rounded-full'>
          Post Comment
        </button>
